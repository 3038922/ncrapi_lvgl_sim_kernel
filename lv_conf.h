 ...
 *Can be used if the UI is above an other layer, e.g. an OSD menu or video
 *player. Requires `LV_COLOR_DEPTH = 32` colors and the screen's `bg_opa` should
 *be set to non LV_OPA_COVER value*/
 ...
 *lv_init(). Note that symbol FSL_RTOS_FREE_RTOS has to be defined in order to
...
#define LV_FONT_DEJAVU_16_PERSIAN_HEBREW                                       \
  1 /*Hebrew, Arabic, Perisan letters and all their forms*/
